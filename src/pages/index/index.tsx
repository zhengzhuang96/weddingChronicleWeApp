 ...
 * @LastEditTime: 2023-12-10 22:07:08
 * @Description:
 */
import { useEffect, useRef } from "react";
import { showShareMenu, openLocation, previewImage, createVideoContext } from "@tarojs/taro";
...
export default function Index() {
  ...
  //   mp4Ref.current?.addEventListener('play', function () { //播放开始执行的函数
  //     console.log("开始播放");
  // });
  }, [])
  ...
  return (
    <ScrollView className='index'>
      ...
      <View className='index-text-box'>
        ...
        <Text className='head-des'>真诚的邀请陪伴我们走过许多岁月的亲人 朋友</Text>
      ...
      <View className='index-banner-5'>
        <Image src={Banner5Left} mode='widthFix'  className='index-banner-5-me' onClick={() => openImg(Banner5Left)} />
        <Image src={Banner5Right} mode='widthFix'  className='index-banner-5-2-me' onClick={() => openImg(Banner5Right)} />
        <Image src={Banner5} mode='widthFix'  className='index-banner-5-1-me' onClick={() => openImg(Banner5)} />
      </View>
      <View className='index-text-box'>
        {/* <Text className='head-title'>亲爱的家人朋友，你好呀！</Text> */}
        <Text className='head-xi'>囍</Text>
      ...
      <View className='index-ye-box'>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/yewan-01.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/yewan-01.png')} />
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/yewan-02.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/yewan-02.png')} />
        </View>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/yewan-03.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/yewan-03.png')} />
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/yewan-04.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/yewan-04.png')} />
        </View>
      </View>
      ...
      <View className='index-zhu-box'>
        <Image src='https://zaowu.bj.bcebos.com/resource/geren/zhu01.png' mode='widthFix'  className='index-zhu-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/zhu01.png')} />
      </View>
      ...
      <View className='index-ye-box'>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/3-1.png' mode='widthFix'  className='index-left-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/3-1.png')} />
        </View>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/3-2.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/3-2.png')} />
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/3-3.png' mode='widthFix'  className='index-ye-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/3-3.png')} />
        </View>
      </View>
      ...
      <View className='index-ye-box'>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/shu2-1.png' mode='widthFix'  className='index-left-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/shu2-1.png')} />
        </View>
        <View className='index-ye'>
          <Image src='https://zaowu.bj.bcebos.com/resource/geren/shu2-2.png' mode='widthFix'  className='index-left-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/shu2-2.png')} />
        </View>
      </View>
      <View className='index-text-box' style={{ marginTop: '60px' }}>
        <Text className='head-des-en'>It looks like you already know deep in my heart.</Text>
      </View>
      <View className='index-heng'>
        <Image src='https://zaowu.bj.bcebos.com/resource/geren/heng-01.png' mode='heightFix'  className='index-heng-me' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/heng-01.png')} />
        <Image src='https://zaowu.bj.bcebos.com/resource/geren/heng-02.png' mode='heightFix'  className='index-heng-me' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/heng-02.png')} />
      </View>
      <View className='index-right-box'>
        <Text className='head-des-en'>Think of you every day.</Text>
        <Text className='head-des-en'>your commpany, happiness is so natural</Text>
      </View>
      <View className='index-zhu-box'>
        <Image src='https://zaowu.bj.bcebos.com/resource/geren/welcome.png' mode='widthFix'  className='index-zhu-img' onClick={() => openImg('https://zaowu.bj.bcebos.com/resource/geren/welcome.png')} />
      </View>
      <View className='index-text-box'>
      ...
      <View className='index-text-box'>
        ...
        <Text className='head-des-tip'>(点击下面地图可导航至这个位置，不迷路)</Text>
        ...
        <Map latitude={35.182654} longitude={116.735474} maxScale={20}
          markers={[
            {
              iconPath: '',
              title: '婚礼地方',
      ...
      <View className='index-showtime'>
        <Image src={hua01} mode='widthFix'  className='index-showtime-head' onClick={() => openImg(hua01)} />
